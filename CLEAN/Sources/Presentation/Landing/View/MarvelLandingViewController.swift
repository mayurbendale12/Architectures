...
class MarvelLandingViewController: UIViewController {
    ...
    private lazy var presenter: MarvelLandingPresenterContract = {
        let getMarvelCharactersUseCase = GetMarvelCharactersUseCase(marvelCharactersRepository: MarvelCharactersRepository())
        return MarvelLandingPresenter(view: self,
                                      getMarvelCharactersUseCase: getMarvelCharactersUseCase,
